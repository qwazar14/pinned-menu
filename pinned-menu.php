...
class PinnedMenu
{
    ...
    function enqueue_scripts()
    {
        ...
        wp_enqueue_script('mpinned-menu-script', plugins_url('pinned-menu.js', __FILE__), array('jquery'), '1.0.0', true);
    }
    ...
    function display_menu()
    {
        ...
        <div class="navigation-list">
            ...
            <div class="navigation-icon navigation-mobile_cat">
                <i class="icon-menu"></i> Категорії
                <ul class="navigation-mobile_subcat">' . $category_list . '</ul>
            </div>
            <a href="#" class="navigation-icon navigation-mobile_search" id="show_search">
                <i class="icon-magnifier"></i> Пошук
            </a>
            <div id="live_searchform" style="display: none;">' .
